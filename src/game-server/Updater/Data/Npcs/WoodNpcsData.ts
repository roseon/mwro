...
export const WoodNpcsData: NpcJson[] = [
	...
	},
	{
		...
		action: {
			type: 'npcSay',
			message: 'I need 8 lost items. Please collect them for me and I will reward you.',
			options: [
				{
	...
	},
	{
		...
		action: {
			type: 'npcSay',
			message:
				'The Crab Pit is opened X on Xday and Y on Yday. We welcome you to take part in the fun.',
		},
	},
	{
		id: 0x80000309,
