...
$baseDir = __DIR__ . '/../mw-tools/build/game-server/file-storage/MythWarServer/_default/BaseItem/';
...
foreach ($files as $file) {
    ...
    // Insert/Update DB
    try {
        $stmt = $pdo->prepare("INSERT INTO BaseItem (id, data) VALUES (?, ?) ON DUPLICATE KEY UPDATE data = VALUES(data)");
...
echo "<div style='color:green; font-weight:bold; margin-top:20px;'>Successfully migrated $count items to MySQL.</div>";
